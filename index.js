...
const contribution = require('./contributedFolder');
...
} = require('./Main/fontSelectedPage/fontSelectedPage')
...
app.use(router)
app.use('fonts/api', contribution.addfont);
...
router.post('/submit-suggestion', upload.single('fontfile'), contribution.addfont);
