(function() {
  ...
  var translations = {
    kn: {
      ...
      heroSubtitle: 'ಕರ್ನಾಟಕದ ಮಹಾನ್ ರಾಜವಂಶಗಳಿಂದ ಪ್ರೇರಿತವಾದ ಫಾಂಟ್‌ಗಳು — ಕಾರ್ಡ್ ಕ್ಲಿಕ್ ಮಾಡಿ ಮತ್ತು ಅಕ್ಷರ ಚಿತ್ರ ರಚಿಸಿ',
      ...
      printEraDesc: 'ಮಿಷನ್ ಮುದ್ರಣಾಲಯಗಳ ಯುಗ ಮತ್ತು ಕನ್ನಡ ಮುದ್ರಣಕಲೆಯ ಜನನ. ಬಾಸೆಲ್ ಮಿಷನ್ (ಮಂಗಳೂರು), ವೆಸ್ಲಿಯನ್ ಮಿಷನ್ (ಬೆಂಗಳೂರು) ಮತ್ತು ಜರ್ಮನ್ ಮಿಷನ್ ಮುದ್ರಣಾಲಯಗಳು ಮೊದಲ ಕನ್ನಡ ಅಕ್ಷರಮುದ್ರಣಗಳನ್ನು ಸೃಷ್ಟಿಸಿದವು.',
      ...
      footerSub: 'ಸಂಚಯ ಅವರಿಂದ ಕನ್ನಡ ಅಕ್ಷರಮುದ್ರಣಗಳ ಡಿಜಿಟಲ್ ಆರ್ಕೈವ್',
